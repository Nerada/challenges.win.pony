...
public class MazeParams
{
    ...
    public int? Difficulty
    {
        ...
        {
            _difficulty = value;
            if (!IsValidDifficulty(value)) throw new InvalidInputException(LocalizationHandler.GetString("MazeParams_wrong_difficulty"));
        }
    }
    ...
    public bool IsValid()
    {
        ...
        if (!IsValidDifficulty(_difficulty)) throw new InvalidInputException(LocalizationHandler.GetString("MazeParams_wrong_difficulty"));
